...
.c1{background-color:#33FFFF;}
.c2{background-color:#33FF99;}
.c3{background-color:#6666CC;}
.c4{background-color:#FF66FF;}
.c5{background-color:#CC99FF;}
.c6{background-color:#ff6666;}
.c7{background-color:#339999;}
.c8{background-color:#0099FF;}
.c9{background-color:#FFA07A;}
              	...
              	<div class="navbar navbar-blue navbar-static-top">  
                    ...
                    <form class="navbar-form navbar-left">
                        <div class="input-group input-group-sm" style="max-width:360px;">
                          <input type="text" class="form-control" placeholder="Search topic"  id="term"onkeyup="search();">
